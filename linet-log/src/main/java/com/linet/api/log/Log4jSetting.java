...
public class Log4jSetting {
    ...
    public void changeLog4jProperties() throws Exception {
        ...
        props.setProperty("log4j.appender.FILE.Directory", FileUtil.getPathFromWhereApplicationIsRunning() + File.separator + "Logs");
    ...
    public void readExternalLog4jProperties() throws Exception {
        ...
        try {
            Properties props = new Properties();
            FileInputStream inputStream = new FileInputStream(new File(FileUtil.getPathFromWhereApplicationIsRunning() + File.separator + "log4j.properties"));
