...
public class ArchivoUtil {
    ...
    public static String getFormatoFile(File f) {
    ...
    public static File inputStreamToTempFile(InputStream entrada,String path) {
        
        File f=null;
        try {

            f = File.createTempFile(path, ".wav" );
